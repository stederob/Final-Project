...
var brown = COLOR([101.0/255, 67.0/255, 33.0/255])
...
var s = STRUCT ([out1,out2,out3,out4,out5,out6,out7,out8])
...
var b = STRUCT ([out1b,out2b,out3b,out4b,out5b,out6b,out7b,out8b])

var cuboid = CUBOID([0.5,5.5,0.2])
var ct = T([0,2])([4.5,4.8])(cuboid)
var ctb = T([0,2])([-0.5,4.8])(cuboid)

var cuboid1 = CUBOID([0.2,4.95,0.2])
var ct1 = T([0,1])([4.5,0.55])(cuboid1)
var ct1b = T([0,1])([-0.2,0.55])(cuboid1)
...
var s1 = STRUCT([out9,out10,out11,out12])

var cuboid2 = CUBOID([0.2,0.2,4.4])
var ct2 = T([0,1,2])([4.5,0.15,0.4])(cuboid2)

var cs = STRUCT([ct2,s1,ct1])
var csb = T([0])([-4.7])(cs)
...
var struct = brown(STRUCT([cs,csb,ctb,ct,s,b,mt,mt1,mt2,mt3]))
...
var f1 = wall_y_with_N_hole(0.1,0.4,3,0.1,1,0.2,1.5,5)
var f2 = wall_y_with_N_hole(0.1,0.4,1.4,0.1,0.5,0.2,0.2,5)
var f1t = T([0,1,2])([-0.15,2.2,1.7])(f1)
var f2t = T([0,1,2])([-0.15,2.2,0.3])(f2)
...
var struct_rif = STRUCT([rif,srt,cx2t,cx2tb,f1t,f2t])
var rif2 = T([0])([4.7])(struct_rif)
var rifinitura = STRUCT([struct_rif,rif2])
 
var sedia = brown(STRUCT([rifinitura,struct]))
...
var schienale = brown(T([1,2])([-0.4,2.1])(R([1,2])([-PI/9])(STRUCT([schienale_int,schienale_ext]))))

//sedile
var sedile = CUBOID([4.5,5.5,0.3])
var sed_t = T([2])([2.3])(sedile)
...
var sedile = brown(STRUCT([centro, srt,s]))
...
var domain_kb = DOMAIN([[-PI/2, PI/2],[-PI/2,PI/2]])([24,36]);
var mapping = sfera(0.15);
var model1 = T([2])([0.1])(MAP(mapping)(domain_kb));
var d = cylinder(0.1,0.1);
var d1 = T([2])([0.1])(DISK(0.15)(24,36));
var kb = STRUCT([model1,d,d1]);


var dt1 = T([0,1,2])([-0.25,5.5,5])(kb)
var dt2 = T([1,2])([0.1,0.75])(R([1,2])(-PI/20)(dt1))
var dt3 = T([0,1,2])([0.02,0.2,1.4])(R([1,2])(-2*PI/20)(dt1))
var dt4 = T([0,1,2])([0.03,0.285,2])(R([1,2])(-3*PI/20)(dt1))
var dt5 = T([0,1,2])([0.04,0.45,2.45])(R([1,2])(-4*PI/20)(dt1))
var knob_left = STRUCT([dt1,dt2,dt3,dt4,dt5])
var knob_right = T([0])([4.95])(knob_left)

var knob = brown(STRUCT([knob_left,knob_right]))

var cilindro = cylinder(0.07,6)
var cilindro_r = R([0,2])(PI/2)(cilindro)
var cilindro_t = COLOR([0,0,0])(T([0,1,2])([-0.7,6.8,4.6])(cilindro_r))
var sfera1 = brown(T([0,1,2])([-0.7,6.8,4.6])(model))
var sfera2 = brown(T([0,1,2])([5.3,6.8,4.6])(model))
var cil_sf = STRUCT([cilindro_t,sfera2,sfera1])

//cerniera
var cil4 = cylinder(0.1,0.6)
var cil4r = R([0,2])([PI/2])(cil4)
var cil4t1 = T([0,1,2])([0.8,5.6,2.65])(cil4r)
var cil4t2 = T([0,1,2])([3.1,5.6,2.65])(cil4r)
var cerniera = COLOR([0.3,0.3,0.3])(STRUCT([cil4t2,cil4t1]))

//ruote
var domain_ruota = DOMAIN([[0,PI/2],[3*PI/8,5*PI/8]])([24,36]);
var mapping1 = sfera(0.3);
var model1 = brown(MAP(mapping1)(domain_ruota));
...
var sedia = STRUCT([sedia,sedile,schienale,knob,cil_sf,cerniera,ruote])
DRAW(sedia)
